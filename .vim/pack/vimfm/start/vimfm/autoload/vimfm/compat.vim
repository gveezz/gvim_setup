...
function! vimfm#compat#glob_list(expr) abort
  if v:version < 703 ||
...
function! vimfm#compat#win_findbuf(bufnr) abort
...
function! vimfm#compat#win_getid() abort
  if !exists('*win_getid')
...
function! vimfm#compat#win_gotoid(expr) abort
