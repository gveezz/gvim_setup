augroup C
   ...
   autocmd BufReadPost,BufWritePost,BufNewFile *.h if line('$') == 1 && getline(1) == '' | call InsTxtFromFile($HOME.'/.vim/templates/header/header.txt', line(1)) | call InsTxtFromFile($HOME.'/.vim/templates/c/ctemplate.h', line('$')) | call InsTxtFromFile($HOME.'/.vim/templates/header/footer.txt', line('$')) | call AdjTemplate() | endif
