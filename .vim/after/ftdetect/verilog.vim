augroup Verilog
   ...
   autocmd BufReadPost,BufWritePost,BufNewFile,BufRead *.v,*.vams if line('$') == 1 && getline(1) == '' | call InsTxtFromFile($HOME.'/.vim/templates/header/header.txt', line(1)) | if stridx(expand('%:t'), 'tb') != -1 | call InsTxtFromFile($HOME.'/.vim/templates/verilog/vtbtemplate.v', line('$')) | elseif stridx(expand('%:t'), 'wrp') != -1 | call InsTxtFromFile($HOME.'/.vim/templates/verilog/vwrptemplate.v', line('$')) | else | call InsTxtFromFile($HOME.'/.vim/templates/verilog/vtbtemplate.v', line('$')) | endif | call InsTxtFromFile($HOME.'/.vim/templates/header/footer.txt', line('$')) | call AdjTemplate() | endif
