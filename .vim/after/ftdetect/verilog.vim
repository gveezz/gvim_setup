augroup Verilog
   ...
   autocmd BufReadPost,BufWritePost,BufNewFile,BufRead *.v,*.vams,*.sv* if line('$') == 1 && getline(1) == '' | :0r $HOME/.vim/templates/kd/kdheader.txt | :$r $HOME/.vim/templates/verilog/vtemplate.v | :call AdjTemplate() | endif
